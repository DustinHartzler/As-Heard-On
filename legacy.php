...
// update version in options table
  ...
  if ($aho_old == '0.5') {
      ...
      $aho_options = array('showlink'       => $aho_showlink,
                           ...
                           'imgmaxheight'   => $aho_imgmaxheight,
                           'deldata'        => $ah_deldata
                    );

      if(get_option('aho_options') === FALSE){
          add_option('aho_options',  $aho_options );
      }else{
          update_option('aho_options', $aho_options );
      }
